import os, re, time, asyncio, subprocess, shutil
...
# Thử nhiều client — web cần JS, android_embed không cần
CLIENTS = ["web", "android_embed", "ios", "tv_embedded"]
...
def _fetch(url: str) -> dict:
    ...
    for client in CLIENTS:
        try:
            ...
            if not formats:
                last_err = f"client={client}: no formats with URL"
                continue
